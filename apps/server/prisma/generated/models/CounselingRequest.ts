...
export type GetCounselingRequestAggregateType<T extends CounselingRequestAggregateArgs> = {
      [P in keyof T & keyof AggregateCounselingRequest]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCounselingRequest[P]>
    : Prisma.GetScalarType<T[P], AggregateCounselingRequest[P]>
}
...
type GetCounselingRequestGroupByPayload<T extends CounselingRequestGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CounselingRequestGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CounselingRequestGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CounselingRequestGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CounselingRequestGroupByOutputType[P]>
      }
    >
  > 
...
export type CounselingRequestCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CounselingRequestFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CounselingRequestDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CounselingRequest'], meta: { name: 'CounselingRequest' } }
  /**
   ...
   * })
  **/
  count<T extends CounselingRequestCountArgs>(
    args?: Prisma.Subset<T, CounselingRequestCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CounselingRequestCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CounselingRequestGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CounselingRequestGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCounselingRequestGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
